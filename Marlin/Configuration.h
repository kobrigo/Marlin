...
#define STRING_CONFIG_H_AUTHOR "(Eyal + thisiskeithb, Ender-3)" // Who made the changes.
...
#define TEMP_SENSOR_CHAMBER 1 //Eyal Enabling the show of the board temperture on the LCD screen
